...
class Program
{
    ...
    {   
        ...
        Lecture l = new Lecture("How to Code 101", "Come learn the basics of coding.", 
        "June 6", "4:45 PM", "Talented Person", 200);
        ...
        Reception r = new Reception("Fancy Wedding", "Celebrate the wedding of the year with us.", 
        "8/18/23", "6-8 PM", "comeToMyWedding@Wmail.com");
        ...
        Outdoor o = new Outdoor("Splish Splash Slide", "We are having a water party!", 
        "Wednesday, July 12", "all day, come anytime!", "Sunny with few clouds");
